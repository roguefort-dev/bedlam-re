...
label-swap correction + squad-base cell 0x11955c, §5) — remaining gaps:
SFX master gate, no-extract latch (each carries its anchor method for
the follow-up unit). T2-T4 aliasing stays later per the W1 ticket.
